						...
						<div class="login-form login-signin py-11">
							...
							<form method="post" action="/login/request" class="form" novalidate="novalidate" id="kt_login_signin_form">
								...
								<div class="form-group">
									...
									<input autofocus name="login" class="form-control form-control-solid h-auto py-7 px-6 rounded-lg" type="text" name="username" autocomplete="off" @if(session('login') != null) value="{{ session('login') }}" @else @if(isset($loginCookie)) value="{{$loginCookie}}" @endif @endif/>
								</div>
								<!--end::Form group-->
								<!--begin::Form group-->
								<div class="form-group">
									...
									<input name="senha" class="form-control form-control-solid h-auto py-7 px-6 rounded-lg" type="password" name="password" autocomplete="off" @if(isset($senhaCookie)) value="{{$senhaCookie}}" @endif/>
								</div>
