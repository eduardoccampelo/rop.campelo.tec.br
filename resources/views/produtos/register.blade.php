											...
											<div class="col-xl-8">
												<div class="kt-section kt-section--first">
													...
													<div id="delivery" style="display: none">
														...
														<div class="row">
															<div class="form-group validated col-12">
																<label class="col-form-label">Descrição (opcional)</label>
																<div class="">
																	<textarea style="width: 800px;height:400px;" class="form-control" name="descricao" placeholder="Descrição" rows="3">{{{ isset($produto->delivery->descricao) ? $produto->delivery->descricao : old('descricao') }}}</textarea>
															...
															<div class="form-group validated col-12">
																...
																<div class="">
																	<textarea style="width: 800px;height:400px;" class="form-control" name="ingredientes" placeholder="Enter a menu" rows="3">{{{ isset($produto->delivery->ingredientes) ? $produto->delivery->ingredientes : old('ingredientes') }}}</textarea>
													...
													<div class="form-group validated col-12">
														...
														<span class="switch switch-outline switch-info">
															<label>
																<input @isset($produto) @if($produto->numero_motor != '') checked @endif @endisset id="tp_veiculo" value="true" class="red-text" type="checkbox">
																<span></span>
															</label>
														</span>
													</div>

													<div class="div_veiculo col-12" style="display: block">
														<div class="row">
															<div class="form-group validated col-lg-4 col-md-4 col-sm-4">
																<label class="col-form-label">Passageiros</label>

																<input type="text" id="passageiros" class="form-control @if($errors->has('passageiros')) is-invalid @endif" name="passageiros" 
																value="{{{ isset($produto->passageiros) ? $produto->passageiros : old('passageiros') }}}">
															...
															<div class="form-group validated col-lg-2 col-md-4 col-sm-2">
																...
																<input data-mask="00" type="text" id="ano" class="form-control @if($errors->has('ano')) is-invalid @endif" name="ano" 
																value="{{{ isset($produto->ano) ? $produto->ano : old('ano') }}}">
																@if($errors->has('ano'))
																<div class="invalid-feedback">
																	{{ $errors->first('ano') }}
																</div>
															...
															<div class="form-group validated col-lg-2 col-md-4 col-sm-2">
																...
																<input data-mask="00" type="text" id="modelo" class="form-control @if($errors->has('modelo')) is-invalid @endif" name="modelo" 
																value="{{{ isset($produto->modelo) ? $produto->modelo : old('modelo') }}}">
															...
															<div class="form-group validated col-lg-4 col-md-4 col-sm-4">
																<label class="col-form-label">Número do motor</label>

																<input type="text" id="numero_motor" class="form-control @if($errors->has('numero_motor')) is-invalid @endif" name="numero_motor" 
																value="{{{ isset($produto->numero_motor) ? $produto->numero_motor : old('numero_motor') }}}">
										...
										<div class="row">
											...
											<div class="col-xl-8">
												...
												<div class="row">
													...
													<div class="form-group validated col-sm-3 col-lg-3">
														<label class="col-form-label">Código benefício</label>
														<div class="">
