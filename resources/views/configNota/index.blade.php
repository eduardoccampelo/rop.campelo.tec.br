							...
							<div class="kt-section kt-section--first">
								<div class="kt-section__body">
									...
									<div class="row">
										...
										<div class="form-group validated col-sm-4 col-lg-4">
											<label class="col-form-label">Código do Municipio</label>
											<div class="">
										...
										<div class="form-group validated col-lg-3 col-md-3 col-sm-10">
											...
											<select id="uf-s" class="custom-select form-control" name="uf">
									...
									<div class="row">
										...
										<div class="form-group validated col-lg-3 col-md-3 col-sm-10">
											<label class="col-form-label text-left">Codigo do Pais</label>
											<div class="">
									...
									<div class="row">
										<div class="form-group validated col-lg-12 col-md-12 col-sm-12">
											<label class="col-form-label text-left">CST/CSOSN Padrão</label>

											<select class="custom-select form-control @if($errors->has('CST_CSOSN_padrao')) is-invalid @endif" name="CST_CSOSN_padrao">
												<option value="">--</option>
											...
											@if($errors->has('CST_CSOSN_padrao'))
											<div class="invalid-feedback">
												{{ $errors->first('CST_CSOSN_padrao') }}
											</div>
											@endif
										</div>
									</div>
									...
									<div class="row">
										<div class="form-group validated col-lg-6 col-md-6 col-sm-6">
											<label class="col-form-label text-left ">CST/PIS Padrão</label>

											<select class="custom-select form-control @if($errors->has('CST_PIS_padrao')) is-invalid @endif" name="CST_PIS_padrao">
												<option value="">--</option>
											...
											@if($errors->has('CST_PIS_padrao'))
											<div class="invalid-feedback">
												{{ $errors->first('CST_PIS_padrao') }}
											</div>
											@endif
										...
										<div class="form-group validated col-lg-6 col-md-6 col-sm-6">
											<label class="col-form-label text-left ">CST/COFINS Padrão</label>

											<select class="custom-select form-control @if($errors->has('CST_COFINS_padrao')) is-invalid @endif" name="CST_COFINS_padrao">
												<option value="">--</option>
												@foreach($listaCSTPISCOFINS as $key => $l)
												<option value="{{$key}}"
												@isset($config)
											...
											@if($errors->has('CST_COFINS_padrao'))
											<div class="invalid-feedback">
												{{ $errors->first('CST_COFINS_padrao') }}
											</div>
											@endif
										</div>
									</div>
									...
									<div class="row">
										<div class="form-group validated col-lg-12 col-md-12 col-sm-12">
											<label class="col-form-label text-left ">CST/IPI Padrão</label>

											<select class="custom-select form-control @if($errors->has('CST_IPI_padrao')) is-invalid @endif" name="CST_IPI_padrao">
												<option value="">--</option>
											...
											@if($errors->has('CST_IPI_padrao'))
											<div class="invalid-feedback">
												{{ $errors->first('CST_IPI_padrao') }}
											</div>
											@endif
										</div>
									</div>
									...
									<div class="row">
										<div class="form-group validated col-lg-6 col-md-6 col-sm-6">
											<label class="col-form-label text-left ">Frete Padrão</label>
										...
										<div class="form-group validated col-lg-6 col-md-6 col-sm-6">
											<label class="col-form-label text-left ">Tipo de pagamento Padrão</label>
									...
									<div class="row">
										...
										<div class="form-group validated col-lg-4 col-md-4 col-sm-10">
											<label class="col-form-label text-left ">Nº Serie NF-e</label>
											<div class="">
										...
										<div class="form-group validated col-lg-4 col-md-4 col-sm-10">
											<label class="col-form-label text-left ">Nº Serie NFC-e</label>
											<div class="">
									...
									<div class="row">
										<div class="form-group validated col-lg-3 col-md-3 col-sm-10">
											<label class="col-form-label text-left ">Ultimo Nº NF-e</label>
											<div class="">
										...
										<div class="form-group validated col-lg-3 col-md-3 col-sm-10">
											<label class="col-form-label text-left ">Ultimo Nº NFC-e</label>
											<div class="">
										...
										<div class="form-group validated col-lg-3 col-md-3 col-sm-10">
											<label class="col-form-label text-left ">Ultimo Nº CT-e</label>
											<div class="">
										...
										<div class="form-group validated col-lg-3 col-md-3 col-sm-10">
											<label class="col-form-label text-left ">Ultimo Nº MDF-e</label>
											<div class="">
									...
									<div class="row">
										<div class="form-group validated col-lg-6 col-md-6 col-sm-6">
											<label class="col-form-label text-left ">CSC</label>
											<div class="">
										...
										<div class="form-group validated col-lg-3 col-md-3 col-sm-3">
											<label class="col-form-label text-left ">CSCID</label>
											<div class="">
										...
										<!-- <div class="form-group validated col-sm-3 col-lg-3">
											<label class="col-form-label text-left ">Certificado A3</label>
											<div class="col-6">
