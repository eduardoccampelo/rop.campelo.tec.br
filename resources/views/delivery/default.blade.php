					...
					<div class="nav-content">
						...
						<h1>
							...
							<a id="logo" class="logo" href="/">
								<img style="max-height: 60px;" src="/images/logo.png" alt="" class="img-fluid">
						...
						<div class="col-lg-6 footer-grid_section_1its footer-text">
							...
							<h2>
								<a class="logo text-wh" href="/">
									<img style="max-height: 50px;" src="/images/logo.png" alt="" class="img-fluid"><span>{{$config->nomeExib(0)}}</span> {{$config->nomeExib(1)}} 
