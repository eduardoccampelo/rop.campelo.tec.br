...
class ConfigNotaController extends Controller
{
	...
	private function _validate(Request $request){
		$rules = [
			...
			'cnpj' => 'required',
			'ie' => 'required',
			'CST_CSOSN_padrao' => 'required',
			'CST_PIS_padrao' => 'required',
			'CST_COFINS_padrao' => 'required',
			'CST_IPI_padrao' => 'required',
		...
		$messages = [
			...
			'CST_CSOSN_padrao.required' => 'Campo obrigatório.',
			'CST_PIS_padrao.required' => 'Campo obrigatório.',
			'CST_COFINS_padrao.required' => 'Campo obrigatório.',
			'CST_IPI_padrao.required' => 'Campo obrigatório.',
